		...
		<div class="templatemo-content col-1 light-gray-bg">
			...
			<div class="templatemo-content-container">
				...
				<div class="templatemo-content-widget no-padding">
					<div class="panel panel-default table-responsive">
						<table
							...
							<tbody>
								<c:forEach var="item" items="${drinks.content}">
									<tr>
										<td>${item.id}</td>
										<td>${item.name}</td>
										<td>${item.price}</td>
				...
				<nav class="pagination-wrap">
					<ul class="pagination">
						<li class="page-item ${drinks.first ? 'disabled' : ''}" ><a href="/admin/drink?page=${drinks.number - 1}">
							<i class="fa-solid fa-caret-left"></i> 
						</a></li>
						
						 <c:forEach varStatus="i" begin="0" end="${drinks.totalPages - 1}">
						 		<li class="${drinks.number == i.index ? 'active' : ''}"><a href="/admin/drink?page=${i.index}">${i.index + 1}</a></li>
						    </c:forEach>
						
						<li class="page-item ${drinks.last ? 'disabled' : ''}"><a href="/admin/drink?page=${drinks.number + 1}">
